...
router.add_api_route(
    "/live-guardian/readiness",
    live_guardian_readiness_page,
    methods=["GET"],
    response_class=HTMLResponse,
    include_in_schema=False,
)
