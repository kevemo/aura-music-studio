...
# Late import keeps the normalized relay in the existing production-mounted LIVE event router
# without expanding the central API composition surface or duplicating route registration.
