...
<title>Aura Auto Cue Prompter — {product}</title>
<style>
...
<p class='muted'>Welcome {display_name}. Paste your LIVE show script below, then open the private prompter window. The script remains inside this browser session and is never inserted into the public overlay source or LIVE event feed.</p>
<section class='grid'>
<div class='card'>
<h2>Show script</h2>
