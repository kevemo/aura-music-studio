...
from .branding import ENDORSEMENT, PRODUCT_NAME
...
AURA_SEC_ENDORSEMENT = "Powered by Aura AI Systems & Elevate Souls Productions"
...
def _product_status() -> dict:
    ...
    return {
        ...
        "truthful_status": (
            ...
            "No device should be described as protected until a signed native agent is installed, enrolled and reporting healthy telemetry."
        ),
...
def aura_sec_status(request: Request):
    ...
    return {"user_id": user["id"], **_product_status()}
