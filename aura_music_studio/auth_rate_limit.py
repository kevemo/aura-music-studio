    ...
    def allow(
        ...
        *,
        ...
        with self._connect() as con:
            ...
            # All configured auth scopes use the same deployment window. Removing globally expired
            # rows keeps the evidence table bounded without retaining raw network identifiers.
