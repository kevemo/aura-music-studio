...
PUBLIC_PAGES = {
    "/": ("ESP Live Sound Studio", "AI music creation, recording and professional production powered by Aura."),
    "/pricing": ("ESP Live Sound Studio Pricing", "Free, Base and Pro membership options for ESP Live Sound Studio."),
    "/ai-music-studio": ("AI Music Studio", "Create, record, arrange, mix and master music with Aura inside ESP Live Sound Studio."),
    "/ai-song-generator": ("AI Song Generator", "Turn lyrics, prompts or recorded ideas into real-audio-first song projects with Aura."),
    "/backing-track-maker": ("AI Backing Track Maker", "Build a complete backing production around an authorized vocal or instrument recording."),
    "/stem-splitter": ("Music Stem Splitter", "Separate vocals and instrument groups for remixing, practice and production workflows."),
    "/ai-mastering": ("AI-Assisted Music Mastering", "Master music with presets, loudness control, translation checks and advanced Pro options."),
    "/ai-vocal-studio": ("AI Vocal Studio", "Record vocals, apply Aura Tune and effects, create harmonies and use consent-approved voice workflows."),
}
...
<section class='card'><h2>What Aura can do</h2><ul>{items}</ul></section>
<section class='card'><h2>Real-audio-first production</h2><p class='muted'>MIDI, notation and MusicXML may guide timing, harmony or performance control, but ESP Live Sound Studio does not accept General MIDI or SoundFont audio as a finished master. Final audible music must come from recorded, neural or approved hybrid waveform audio.</p></section>
...
def ai_music_studio():
    return _page(
        ...
        ["Original song creation", "Browser recording", "Build Around Upload", "Generative multitrack production", "Aura Tune and FX", "Mixing/mastering", "Take lanes and project history"],
    )
...
def ai_song_generator():
    return _page(
        ...
        "Aura can structure an original song from a concept or lyrics, apply genre/instrument choices and route the project into real-audio generation rather than stopping at a MIDI sketch.",
        ["Prompt and lyric input", "Verse/chorus/bridge structure", "Genre, BPM, key and instrument controls", "Regeneration workflow", "Base daily confirmed track", "Pro unlimited full-song production"],
    )
...
def backing_track_maker():
    return _page(
        ...
        "Upload or record an authorized lead vocal, guitar, piano, bass, drums or other musical anchor and let Aura create complementary parts around it.",
        ["Preserve the uploaded anchor", "Select guitar/drum/bass/keyboard and other performance types", "Optional original lead/backing vocals", "Base complete-mix workflow", "Pro editable multitrack generation", "AutoMix, effects and mastering"],
    )
...
def stem_splitter():
    return _page(
        ...
        ["Reduced two/four-stem workflows", "Pro six-stem and detailed routes", "Vocal/instrument separation", "Private per-member outputs", "Background processing queue", "DAW-ready follow-on editing"],
    )
...
def ai_mastering():
    return _page(
        ...
        "Aura Master combines one-click character choices with engineering controls and optional local reference-mastering tools.",
        ["Multiple mastering characters", "LUFS and true-peak control", "EQ and stereo-width adjustment", "Translation/mono checks", "Pro reference mastering", "Album/EP consistency workflow"],
    )
...
def ai_vocal_studio():
    return _page(
        "/ai-vocal-studio",
        "Record, tune, process and arrange vocals with Aura.",
        "Capture a dry vocal in the browser, build a track around it, tune it, add effects and create harmonies while keeping voice-conversion workflows consent-gated.",
        ["Browser vocal recording", "Aura Tune", "Vocal FX presets", "Harmony Architect", "Contextual backing harmonies", "Consent-approved voice profiles", "Take lanes and phrase comping on Pro"],
    )
...
def manifest() -> Response:
    payload = {
        ...
        "short_name": "ESP Live Sound Studio",
        "description": "AI music creation, recording and professional production powered by Aura.",
        "start_url": "/",
        "scope": "/",
        "display": "standalone",
