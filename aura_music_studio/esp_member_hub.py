...
MODULES: tuple[dict[str, Any], ...] = (
    ...
    {"id":"collaborate","title":"Collaborate, Battles & Events","audience":{"creator","agent","owner"},"status":"designed","path":None,"summary":"Opt-in battle scheduling, co-host/collaboration matching, reliability, event operations and pre/post content plans.","group":"Shared ESP"},
    {"id":"commerce","title":"Commerce / Shop Creator Centre","audience":{"creator","agent","owner"},"status":"designed","path":None,"summary":"Shop readiness, opportunities, samples, deadlines, disclosures and seller/creator matching where regional programmes permit.","group":"Shared ESP"},
    {"id":"brands","title":"Brands & Commercial Opportunities","audience":{"creator","agent","owner"},"status":"designed","path":None,"summary":"Opt-in commercial profiles, media kits, opportunities, creator matching, fulfilment, reporting and renewals.","group":"Shared ESP"},
    ...
    {"id":"incentives","title":"Incentives, Rewards & Eligibility","audience":{"creator","owner"},"status":"designed","path":None,"summary":"Current incentive programmes, recognition, ambassador/equipment pathways and transparent eligibility checks.","group":"Creator"},
