...
</style></head><body><nav class='nav'><div class='wrap navin'><a class='brand' id='gameHomeLink' href='/game-creation'>__BRAND__<small>Aura Game Forge · Export Studio</small></a><div><a class='btn' id='playLink' href='#'>Playtest</a> <a class='btn' id='captureLink' href='#'>Capture Card</a> <a class='btn' id='stateLink' href='#'>State Machines</a></div></div></nav><main class='wrap'><section class='hero'><div class='eyebrow'>Integrity-bound delivery</div><h1 id='title'>Game Export Studio</h1><p class='muted'>Package the exact current Aura build as an installable offline-capable PWA, open the Godot 4 developer-preview source adapter, or use the browser-local Capture Card display for compatible console HDMI capture hardware.</p><div id='projectContext' class='projectContext'></div><div id='notice' class='notice'></div></section><section class='grid'><div><div class='card'><div class='eyebrow'>Production-ready export</div><h2>Aura Web PWA Package</h2><p class='muted'>Includes the reviewed play runtime, installable manifest, same-origin offline cache, supplied Command Center artwork, checksum-verified media and provenance manifest. Requires a current build plus confirmed project and media rights.</p><button id='exportBtn' class='primary'>Create Aura Web PWA Export</button><a id='download' class='btn download' href='#'>Download ZIP</a><div id='result' class='muted'></div></div><div class='card preview'><div class='eyebrow'>Console play display</div><h2>HDMI Capture Card</h2><p class='muted'>Use a compatible USB/Thunderbolt capture device as a low-latency browser video source. The feed stays local to your browser on the capture page and can be viewed fullscreen, Picture in Picture or in a clean pop-out window.</p><a id='captureCardBtn' class='btn' href='#'>Open Capture Card Display</a></div><div class='card preview'><div class='eyebrow'>Developer-preview adapter</div><h2>Godot 4 Source Project</h2><p class='muted'>Generate a deterministic Godot 4 source ZIP from current Game/World DNA and verified media. The adapter uses a fixed reviewed GDScript template and deliberately does <b>not</b> claim full Aura runtime parity or production readiness yet.</p><a id='godotLink' class='btn' href='#'>Open Godot Source Preview</a></div><div class='card'><div class='eyebrow'>Adapter roadmap</div><div id='targets'>Loading export capabilities…</div></div></div><div><div class='card'><div class='eyebrow'>Safety contract</div><h3>No fake engine exports</h3><p class='muted'>Phaser and the browser 3D external adapters remain planned. Godot now has a real source-project preview, but production-equivalent parity stays false until generated projects pass a pinned Godot 4 headless CI gate.</p></div><div class='card'><div class='eyebrow'>Provenance</div><p class='muted'>Aura Web export identifiers include the current export-format version plus integrity hash. ZIP timestamps and manifest provenance are stable for a fixed build, so an unchanged build and unchanged verified media reproduce the same package bytes.</p></div></div></section></main><script>
