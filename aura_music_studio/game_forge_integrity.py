...
def game_integrity_hash(game: GameDNA) -> str:
    """Hash Game DNA, World DNA and every verified runtime asset snapshot.

    Public-test approval is bound to this value. Editing the game/world, changing explicit asset
    or model bindings, importing/removing media or models, changing rights, or changing snapshot
    bytes therefore invalidates the previous build and assessment.
    """
    payload = {
