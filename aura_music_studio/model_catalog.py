...
CATALOG: tuple[ModelPolicy, ...] = (
    ...
    ModelPolicy(
        id="yue",
        component="YuE",
        role="lyrics-first full-song generation",
        ...
        model_license="review current model card before enabling",
        commercial_use="not assumed; must pass deployment licence review",
    ),
    ModelPolicy(
        id="the-muser",
        component="The Muser",
