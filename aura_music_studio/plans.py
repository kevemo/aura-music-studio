...
class Plan:
    ...
    def price_for(self, period: BillingPeriod | str = BillingPeriod.MONTHLY) -> Decimal:
        ...
        if self.annual_price is None:
            raise ValueError(f"Annual billing is not available for {self.name}")
...
PLANS: dict[str, Plan] = {
    ...
    "pro": Plan(
        ...
        description=(
            ...
            "rate-control, anti-abuse and safety safeguards. Includes the complete enabled production stack: expanded "
            ...
            "spatial audio, video/music sync, enabled export formats, and unlimited active Game Forge project workspaces. "
            "Eligible song/game publishing remains subject to marketplace entitlement, rights and governance gates."
        ),
