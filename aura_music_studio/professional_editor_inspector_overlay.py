...
(()=>{
  ...
  root.innerHTML=`
    ...
    <div class="probox"><h4>Render / Preview</h4><div class="exportrow">
      ...
      <label class="label">Frame time<input class="field" id="proExportTime" type="number" min="0" step=".01" value="0"></label>
      <button class="btn primary" id="proRender">Render</button>
    </div><div id="proExportResult" class="exportresult muted">Exports flatten the selected editor state; sources remain unchanged.</div></div>`;
  panel.append(root);
...
__all__ = ["PRO_EDITOR_CONTROLS_JS", "router"]
