    ...
    try:
        ...
        return {
            ...
            "selection_contract": {
                ...
                "server_authoritative_live_binding": "reference_available_processor_binding_unavailable",
                "binding_storage": "Chat 5 LIVE source/session relationship state only",
                "profile_or_model_data_copied_into_chat5": False,
