...
def _authorization():
    return AuraModeratorAuthorization(creator_handle="creator.live", creator_consent=True, moderator_assignment_confirmed=True, mode=ModerationMode.AUTO_PROTECT, provider_write_enabled=True)
