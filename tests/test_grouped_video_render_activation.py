...
from aura_music_studio.professional_video_mask_crop_compositor import UniversalVisualVideoCompositor
...
def test_universal_visual_compositor_preserves_grouped_unified_renderer_foundation():
    # Mask/crop interoperability extends the track-keyframe/keyframed-mask/chroma/grouped stack
    # rather than bypassing masks, blends or grouped-track state.
