...
from aura_music_studio.professional_video_track_keyframe_universal_compositor import UniversalVisualVideoCompositor
...
def test_universal_visual_compositor_preserves_grouped_unified_renderer_foundation():
    ...
    # compatibility layer rather than bypassing masks, blend or grouped-track state.
